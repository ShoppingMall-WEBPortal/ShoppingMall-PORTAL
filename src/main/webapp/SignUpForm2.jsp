	...
	<div id="table">
		<form action="SignUpProcess.do">
			...
			<input type="text" class="text" placeholder="ID" name="id"> <input
				type="password" class="text" placeholder="Password" name="password">
			...
			<div style="display: flex;">
				<input name="birthday" type="text" pattern="[0-9]+" class="text"
					placeholder="생일을 입력하세요 ex) 980101" style="width: 300px;">
			...
			<div style="display: flex;">
				<input type="text" name="postcode" id="sample6_postcode"
					class="text" placeholder="우편번호">&emsp; <input type="button"
					onclick="sample6_execDaumPostcode()" value="우편번호 찾기">
			</div>
			<div>
				<input type="text" name="basicAddr" id="sample6_address"
					class="text" placeholder="주소"> <input type="text"
					name="detailAddr" id="sample6_detailAddress" class="text"
					placeholder="상세주소">
			</div>
